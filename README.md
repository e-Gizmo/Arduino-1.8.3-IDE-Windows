...
1. Install first the PL2303 Driver for gizDuino boards! or go to Arduino 1.8.3 folder>drivers>Prolific USB Drivers
 -----
...
3. Unzip Compressed folder to your desktop.
  -----
 -  You can now open the ###### Arduino 1.8.3.exe to program your gizDuino.
